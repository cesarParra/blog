...
In quantum mechanics there is this concept where things exist in several different states at the same time, and the state is only determined once the thing is observed.
