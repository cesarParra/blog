    ...
    return (
        <nav {...props}>
            <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
                <NavItem currentPath={props.currentPath} href="/about">About</NavItem>
                <NavItem currentPath={props.currentPath} href="/articles">Articles</NavItem>
                <NavItem currentPath={props.currentPath} href="/projects">Projects</NavItem>
                <NavItem currentPath={props.currentPath} href="/speaking">Speaking</NavItem>
                <NavItem currentPath={props.currentPath} href="/uses">Uses</NavItem>
            </ul>
        </nav>
    )
}
